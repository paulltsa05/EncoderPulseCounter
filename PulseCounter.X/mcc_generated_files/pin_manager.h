...
// get/set EXTRA_OUT_RB7 aliases
#define EXTRA_OUT_RB7_TRIS               TRISBbits.TRISB7
#define EXTRA_OUT_RB7_LAT                LATBbits.LATB7
#define EXTRA_OUT_RB7_PORT               PORTBbits.RB7
#define EXTRA_OUT_RB7_WPU                WPUBbits.WPUB7
#define EXTRA_OUT_RB7_OD                ODCONBbits.ODCB7
#define EXTRA_OUT_RB7_ANS                ANSELBbits.ANSB7
#define EXTRA_OUT_RB7_SetHigh()            do { LATBbits.LATB7 = 1; } while(0)
#define EXTRA_OUT_RB7_SetLow()             do { LATBbits.LATB7 = 0; } while(0)
#define EXTRA_OUT_RB7_Toggle()             do { LATBbits.LATB7 = ~LATBbits.LATB7; } while(0)
#define EXTRA_OUT_RB7_GetValue()           PORTBbits.RB7
#define EXTRA_OUT_RB7_SetDigitalInput()    do { TRISBbits.TRISB7 = 1; } while(0)
#define EXTRA_OUT_RB7_SetDigitalOutput()   do { TRISBbits.TRISB7 = 0; } while(0)
#define EXTRA_OUT_RB7_SetPullup()      do { WPUBbits.WPUB7 = 1; } while(0)
#define EXTRA_OUT_RB7_ResetPullup()    do { WPUBbits.WPUB7 = 0; } while(0)
#define EXTRA_OUT_RB7_SetPushPull()    do { ODCONBbits.ODCB7 = 1; } while(0)
#define EXTRA_OUT_RB7_SetOpenDrain()   do { ODCONBbits.ODCB7 = 0; } while(0)
#define EXTRA_OUT_RB7_SetAnalogMode()  do { ANSELBbits.ANSB7 = 1; } while(0)
#define EXTRA_OUT_RB7_SetDigitalMode() do { ANSELBbits.ANSB7 = 0; } while(0)
